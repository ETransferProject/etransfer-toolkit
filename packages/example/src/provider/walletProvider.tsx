...
import { AelfReact, SupportedChainId } from '@/constants';
...
function WalletProvider({ children }: { children: React.ReactNode }) {
  ...
  const { callSendMethod: callMainChainSendMethod, callViewMethod: callMainChainViewMethod } = useCallContract({
    chainId: SupportedChainId.mainChain,
    rpcUrl: AelfReact[SupportedChainId.mainChain].rpcUrl,
  });
  const { callSendMethod: callSideChainSendMethod, callViewMethod: callSideChainViewMethod } = useCallContract({
  ...
  }, [callMainChainSendMethod, callMainChainViewMethod, callSideChainSendMethod, callSideChainViewMethod]);
