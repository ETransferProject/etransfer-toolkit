...
import { DEFAULT_NULL_VALUE } from '../../src/constants/common';

describe('isEffectiveNumber function', () => {
  it('should return false for NaN', () => {
    expect(isEffectiveNumber('invalid')).toBe(false);
  });

  it('should return false for 0', () => {
    expect(isEffectiveNumber(0)).toBe(false);
  });

  it('should return false for negative numbers', () => {
    expect(isEffectiveNumber(-5)).toBe(false);
  });

  it('should return true for valid positive numbers', () => {
    expect(isEffectiveNumber(5)).toBe(true);
    expect(isEffectiveNumber(0.1)).toBe(true);
  });

  it('should return false for string representations of invalid numbers', () => {
    expect(isEffectiveNumber('abc')).toBe(false);
  });
});
