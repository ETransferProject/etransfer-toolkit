...
export default function MobileHeaderSelectMenu({ activeMenuKey, isUnreadHistory, onChange }: MobileSelectMenuProps) {
  ...
  return (
    <>
      <div
        ...
        <MenuOutlined className={'etransfer-ui-mobile-header-select-menu-icon'} />
      </div>
      <CommonDrawer
        zIndex={301}
        className={clsx(
          'etransfer-ui-mobile-header-select-menu-drawer',
          'etransfer-ui-mobile-header-select-menu-drawer-weight',
        )}
        height="100%"
        open={isDrawerOpen}
